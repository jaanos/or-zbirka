...
\caption{Podatki za nalogi~\ref{nal:brezzobec} (prvi štirje stolpci)
in~\ref{nal:brezzobec-pert}.}
\label{tab:brezzobec}
\end{table}
\end{vprasanje}
\begin{odgovor}
...
\begin{vprasanje}[nal:splet]
Izdelati želimo terminski plan za izdelavo spletne aplikacije.
V tabeli~\ref{tab:splet} so zbrana opravila pri izdelavi.
...
\caption{Podatki za nalogo~\ref{nal:splet}}
\label{tab:splet}
\end{table}
\end{vprasanje}
\begin{odgovor}
...
V tabeli~\ref{tab:studij} so našteti izbirni predmeti
...
\caption{Podatki za nalogo~\ref{nal:studij}.}
\label{tab:studij}
\end{table}
\end{vprasanje}
\begin{odgovor}
...
\begin{vprasanje}[nal:konferenca]
Izdelati želimo terminski plan za organizacijo konference.
V tabeli~\ref{tab:konferenca} so zbrana opravila pri organizaciji.
...
\caption{Podatki za nalogo~\ref{nal:konferenca}.}
\label{tab:konferenca}
\end{table}
\end{vprasanje}
\begin{odgovor}
\end{odgovor}
...
\begin{vprasanje}[nal:letalo]
Pri izdelavi letala imamo faze, opisane v tabeli~\ref{tab:letalo}.
...
\caption{Podatki za nalogo~\ref{nal:letalo}}
\label{tab:letalo}
\end{table}
\end{vprasanje}
\begin{odgovor}
