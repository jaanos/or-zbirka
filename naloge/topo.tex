...
\begin{algorithmic}
\Function{najkrajšaPot}{$Graph, s, e$}
	...
	\For{$\forall u \in topo$}
		\For{$\forall$ u $\rightarrow$ v}
			\If{$dist[v] \ \textgreater \ dist[u] + l(u, v)$}
	...
	\While{\True}
		...
		\If{$predhodnik = s ali predhodnik = None$}
