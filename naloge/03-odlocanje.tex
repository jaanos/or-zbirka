...
\begin{vprasanje}[nal:dectree2]
Dano je odločitveno drevo s slike~\ref{fig:dectree2},
...
\end{tikzpicture}
\caption{Odločitveno drevo za nalogo~\ref{nal:dectree2}.}
\label{fig:dectree2}
\end{figure}
\end{vprasanje}
\begin{odgovor}
...
\end{tikzpicture}
\caption{Shema možnih poti za nalogo~\ref{nal:vrac}.}
\label{fig:vrac}
\end{figure}
\end{vprasanje}
\begin{odgovor}
...
\begin{vprasanje}[nal:dectree3]
Dano je odločitveno drevo s slike~\ref{fig:dectree3},
...
\end{tikzpicture}
\caption{Odločitveno drevo za nalogo~\ref{nal:dectree3}.}
\label{fig:dectree3}
\end{figure}
\end{vprasanje}
\begin{odgovor}
