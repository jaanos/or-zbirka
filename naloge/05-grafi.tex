...
\end{tikzpicture}
\caption{Graf za nalogi~\ref{nal:pocitnice} (brez uteži) in~\ref{nal:pot}.}
\label{fig:pocitnice}
\end{figure}
\end{vprasanje}
\begin{odgovor}
...
\draw (D) -- (J) -- (I) -- (D) -- (C) -- (I);
\end{tikzpicture}
\caption{Graf za nalogo~\ref{nal:prerezna}.}
\label{fig:prerezna}
\end{figure}
\end{vprasanje}
\begin{odgovor}
...
\end{tikzpicture}
\caption{Graf za nalogo~\ref{nal:dag}.}
\label{fig:dag}
\end{figure}
\end{vprasanje}
\begin{odgovor}
...
v grafu s slike~\ref{fig:pocitnice}.
