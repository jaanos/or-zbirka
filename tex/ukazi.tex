...
\newcommand{\add}{\ensuremath{\operatorname{add}}}
\newcommand{\append}{\ensuremath{\operatorname{append}}}
\newcommand{\pop}{\ensuremath{\operatorname{pop}}}
\newcommand{\remove}{\ensuremath{\operatorname{remove}}}
\newcommand{\isEmpty}{\ensuremath{\operatorname{isEmpty}}}
\newcommand{\visited}{\ensuremath{\text{\sl visited}}}
\newcommand{\postlabel}{\ensuremath{\text{\sl postlabel}}}
\newcommand{\pred}{\ensuremath{\text{\sl pred}}}
\newcommand{\True}{\ensuremath{\text{\sc True}}}
\newcommand{\False}{\ensuremath{\text{\sc False}}}
\newcommand{\Null}{\ensuremath{\text{\sc Null}}}
\newcommand{\NOp}{\ensuremath{\text{\sc NoOp}}}
\newcommand{\visit}{\ensuremath{\text{\sc Visit}}}
\newcommand{\previsit}{\ensuremath{\text{\sc Previsit}}}
\newcommand{\postvisit}{\ensuremath{\text{\sc Postvisit}}}
\newcommand{\Init}{\ensuremath{\text{\sc Init}}}
\newcommand{\AddVertex}{\ensuremath{\text{\sc AddVertex}}}
\newcommand{\AddEdge}{\ensuremath{\text{\sc AddEdge}}}
\newcommand{\DelVertex}{\ensuremath{\text{\sc DelVertex}}}
\newcommand{\DelEdge}{\ensuremath{\text{\sc DelEdge}}}
...
\newenvironment{slika}[1][t]{\setlabel{\thislabel}\begin{figure}[#1]\centering}{\label{fig:\curlabel}\end{figure}}
\newenvironment{tabela}[1][t]{\setlabel{\thislabel}\begin{table}[#1]\centering}{\label{tab:\curlabel}\end{table}}
